...
public class GettingStartedSliceProvider extends SliceProvider {
    ...
    public Slice onBindSlice(Uri sliceUri) {
        ...
        Log.i("xiabo", "onBindSlice " + sliceUri);
        ...
        } else if ("/switch".equals(sliceUri.getPath())) {
            return createBrightnessSlice(sliceUri);
        } else if ("/toast".equals(sliceUri.getPath())) {
            return createSlice(sliceUri);
        } else if ("/count".equals(sliceUri.getPath())) {
            return createDynamicSlice(sliceUri);
        } else {
            listBuilder.addRow(new ListBuilder.RowBuilder()
    ...
    public SliceAction createActivityAction() {
        ...
        return SliceAction.create(
                PendingIntent.getActivity(
                        getContext(),
                        0,
                        new Intent(getContext(), Main2Activity.class),
                        0
                ),
